...
def customer_signup():
    if request.method == 'POST':
        ...
        # Get first 7 digits of contact number as customer ID
        customer_id = int(contact[:7])
        ...
        try:
            cursor.execute(
                "INSERT INTO CUSTOMERS (CUSTOMERID, CUSTOMERNAME, CONTACT, EMAIL, PASSWORD) VALUES (%s, %s, %s, %s, %s)",
...
def employee_signup():
    ...
    if request.method == 'POST':
        ...
        employee_id = int(contact[:7])  # First 7 digits as ID
